...
export const PlaylistIdParam = z
  .object({
    playlistId: ObjectIdSchema,
  })
  .strict();

export const PlaylistVideoIdParam = z
  .object({
...
export const UserIdParam = z
  ...
  .strict();
export const PlaylistCreateBody = z
  .object({
...
export const PlaylistUpdateBody = PlaylistCreateBody.partial().refine(
